...
export function formatMissingRipgrepMessage(result) {
    let reason;
...
export async function ensureToolWithStatus(tool, silent = true) {
...
export async function ensureTool(tool, silent = true) {
