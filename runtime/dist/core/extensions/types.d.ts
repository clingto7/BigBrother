...
import type { BashToolDetails, BashToolInput, EditToolInput, IpythonToolDetails, IpythonToolInput } from "../tools/index.js";
...
export type SessionEvent = SessionStartEvent | SessionBeforeSwitchEvent | SessionBeforeForkEvent | SessionBeforeCompactEvent | SessionCompactEvent | SessionBeforeRefineEvent | SessionShutdownEvent | SessionBeforeTreeEvent | SessionTreeEvent;
...
export type ToolResultEvent = BashToolResultEvent | EditToolResultEvent | IpythonToolResultEvent | CustomToolResultEvent;
...
export declare function isIpythonToolResult(e: ToolResultEvent): e is IpythonToolResultEvent;
/**
...
export declare function isToolCallEventType(toolName: "ipython", event: ToolCallEvent): event is IpythonToolCallEvent;
...
export interface ExtensionAPI {
    ...
    on(event: "session_before_refine", handler: ExtensionHandler<SessionBeforeRefineEvent, SessionBeforeRefineResult>): void;
