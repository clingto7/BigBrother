 ...
 * no reporter at all.
 */
export function hasFileBasedHerdrIntegration(loadedExtensionPaths) {
 ...
 */
export function createHerdrAgentStateExtension(getLoadedExtensionPaths) {
    return (pi) => {
...
export const herdrAgentStateExtension = (pi) => {
    herdrAgentStateExtensionImpl(pi, () => []);
};
function herdrAgentStateExtensionImpl(pi, getLoadedExtensionPaths) {
...
//# sourceMappingURL=herdr-agent-state.js.map