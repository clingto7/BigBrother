...
export declare const COMPACT_SKILL_NAME = "compact";
 ...
 */
export declare function buildSummarizationPrompt(customInstructions?: string, previousSummary?: string): string;
/**
