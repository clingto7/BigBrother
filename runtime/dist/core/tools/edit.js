import { Box, Container, Spacer, Text, wrapTextWithAnsi } from "@earendil-works/pi-tui";
import { constants } from "fs";
import { access as fsAccess, readFile as fsReadFile, writeFile as fsWriteFile } from "fs/promises";
import { Type } from "typebox";
import { renderDiff } from "../../modes/interactive/components/diff.js";
import { countChangedLines, FILE_CHANGE_DIFF_INDENT, formatFileChangeSummaryLine, } from "../../modes/interactive/components/edit-summary.js";
...
class EditChangeSummaryComponent {
    ...
    diffsExpanded;
    diffLines;
    constructor(rawPath, cwd, change, diffsExpanded, diffLines) {
...
function buildEditCallComponent(component, args, theme, expanded, cwd) {
    ...
    component.addChild(new Spacer(1));
    component.addChild(new EditChangeSummaryComponent(rawPath ?? "...", cwd, change, 
    ...
    // agent-message hints.
    expanded, expanded ? renderDiff(component.preview.diff).split("\n") : undefined));
    return component;
}
...
export function createEditToolDefinition(cwd, options) {
    ...
    const definition = {
        ...
        renderResult(result, _options, theme, context) {
            ...
            if (callComponent) {
                ...
                if (changed) {
                    buildEditCallComponent(callComponent, context.args, theme, context.expanded, context.cwd);
                }
            }
    ...
    return Object.assign(definition, { replayBuiltInToolName: "edit" });
}
