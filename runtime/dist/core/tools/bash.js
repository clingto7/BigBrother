...
function rebuildBashResultRenderComponent(component, result, options, showImages, includeImageDimensions, showExpandHint, startedAt, endedAt) {
...
export function createBashToolDefinition(cwd, options) {
    ...
    const definition = {
        ...
        renderResult(result, options, _theme, context) {
            ...
            rebuildBashResultRenderComponent(component, result, options, context.showImages, context.includeImageDimensions, context.showExpandHint !== false, state.startedAt, state.endedAt);
            component.invalidate();
            return component;
        },
    };
    return Object.assign(definition, { replayBuiltInToolName: "bash" });
}
