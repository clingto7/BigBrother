 ...
 */
export function isNoModelsAvailableMessage(message) {
...
export function formatAuthenticationFailedMessage(provider) {
    return (`Authentication failed for "${provider}". Credentials may have expired or network is unavailable.\n\n` +
        LOGIN_RECOVERY_MESSAGE);
}
export function isLikelyAuthenticationError(message) {
...
export function addLoginGuidanceToAuthError(message) {
