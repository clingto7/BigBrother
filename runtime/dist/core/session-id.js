...
export function formatSessionDisplayId(id) {
...
export function matchesSessionIdSuffix(candidate, suffix) {
...
export function matchesSavedSessionSelector(candidate, selector) {
    const normalizedCandidate = normalizeHexSessionId(candidate);
...
function normalizeHexSessionId(id) {
