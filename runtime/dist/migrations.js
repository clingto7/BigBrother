...
function isSessionJsonlFile(filePath) {
    try {
...
function isLegacySessionDirName(name) {
    return /^--.+--$/.test(name);
}
/**
 ...
 */
export function migrateLegacySessionDirsToSessionRoot() {
    const agentDir = getAgentDir();
...
function uniqueSessionRootPath(sessionsDir, file) {
