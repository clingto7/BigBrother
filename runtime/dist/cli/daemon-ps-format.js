...
export function formatDaemonListTable(daemons) {
...
function formatDaemonCell(_row, column, value) {
    if (column !== "status") {
        return value;
    }
    return colorStatus(value.trim(), value);
}
function colorStatus(status, value) {
    switch (status) {
        case "current":
...
//# sourceMappingURL=daemon-ps-format.js.map