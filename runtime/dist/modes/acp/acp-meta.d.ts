...
export declare const PRIME_AGENT_META_NAMESPACE = "ai.primeintellect.prime-agent";
...
export declare function primeAgentMeta(payload: PrimeAgentSessionMeta): Record<string, unknown>;
//# sourceMappingURL=acp-meta.d.ts.map