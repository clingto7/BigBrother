...
export class BorderedLoader extends Container {
    ...
    constructor(tui, theme, message, options) {
        ...
        if (this.cancellable) {
            this.loader = new CancellableLoader(tui, (s) => theme.fg("muted", s), (s) => theme.fg("muted", s), message);
        }
        else {
            this.signalController = new AbortController();
            this.loader = new Loader(tui, (s) => theme.fg("muted", s), (s) => theme.fg("muted", s), message);
        }
