...
export function isLeadingSlashCommand(text, isRecognized) {
    const command = parseSlashCommand(text);
    return command !== undefined && isRecognized(command.name);
}
export function styleSlashCommandText(text, styleRest = (rest) => rest) {
...
//# sourceMappingURL=slash-command-message.js.map