...
declare class TreeList implements Component {
    ...
    constructor(tree: AgentConnectionSessionTreeNode[], currentLeafId: string | null, maxVisibleLines: number, initialSelectedId?: string, initialFilterMode?: FilterMode);
    /**
...
export declare class TreeSelectorComponent extends Container implements Focusable {
    ...
    constructor(tree: AgentConnectionSessionTreeNode[], currentLeafId: string | null, terminalHeight: number, onSelect: (entryId: string) => void, onCancel: () => void, onLabelChange?: (entryId: string, label: string | undefined) => void, initialSelectedId?: string, initialFilterMode?: FilterMode);
