...
function renderLabelShimmer(characters, frame) {
    ...
    return characters
        .map((character, index) => theme.fg(Math.abs(index - center) <= SHIMMER_RADIUS ? "muted" : "thinkingText", character))
        .join("");
}
...
//# sourceMappingURL=feature-hint.js.map