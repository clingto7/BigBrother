...
export function createSessionSearchText(parts) {
...
export function matchSearchText(text, parsed) {
    ...
    for (const token of parsed.tokens) {
        ...
        if (!m.matches || m.score > STRICT_FUZZY_MAX_TOKEN_SCORE)
            return { matches: false, score: 0 };
        totalScore += m.score;
    }
...
//# sourceMappingURL=session-view-search.js.map