...
export function rlmSubagentDisplayPath(sessionDir) {
    return join(sessionDir, RLM_SUBAGENT_DISPLAY_FILE);
}
function isRlmSubagentDisplayEntry(value) {
    if (!value || typeof value !== "object")
        return false;
    const entry = value;
    return (entry.type === "rlm_subagent" &&
...
export function writeRlmSubagentDisplayEntry(entry) {
...
export async function readRlmSubagentDisplayEntry(sessionDir) {
    let contents;
    try {
...
//# sourceMappingURL=rlm-subagent-display.js.map