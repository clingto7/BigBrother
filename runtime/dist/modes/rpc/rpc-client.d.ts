...
import type { RpcObservedSessionEvent, RpcSessionState, RpcSlashCommand } from "./rpc-types.js";
/** Extended response timeout for refine requests, which run an LLM pass. */
export declare const REFINE_REQUEST_TIMEOUT_MS: number;
...
export declare class RpcClient {
    ...
    private observedSessionListeners;
    ...
    listSchedules(includeInactive?: boolean): Promise<AgentCronJob[]>;
    addSchedule(schedule: string, prompt: string): Promise<AgentCronJob>;
    cancelSchedule(jobId: string): Promise<AgentCronJob>;
    listHeartbeats(): Promise<AgentConnectionHeartbeat[]>;
    getHeartbeat(): Promise<AgentCronJob | null>;
    setHeartbeat(schedule: string, prompt: string, deliveryMode?: AgentHeartbeatDeliveryMode): Promise<AgentCronJob>;
    updateHeartbeat(action: AgentHeartbeatUpdateAction): Promise<AgentCronJob | null>;
    manageHeartbeat(activeSessionId: string, jobId: string, action: AgentHeartbeatManagementAction): Promise<AgentCronJob>;
    observe(activeSessionId: string): Promise<AgentMessage[]>;
    unobserve(activeSessionId: string): Promise<void>;
    /**
