...
export function createAgentConnectionState(runtime, activeSessionId) {
...
export function createAgentConnectionSnapshot(runtime, activeSessionId) {
    const session = runtime.session;
    const sessionManager = session.sessionManager;
    return {
...
export function createAgentConnectionCommands(session) {
    return [
...
export function createAgentConnectionResourceSnapshot(session) {
...
export function toConnectionModel(model) {
    return model;
}
function createArtifactReference(session, type, filePath) {
    if (!filePath) {
        return undefined;
    }
...
function createArtifactPathInfo(filePath, cwd) {
