...
import type { QueuedMessageLane, QueuedMessageMutation, QueuedMessageMutationStatus, SessionActionSnapshot } from "../../core/session-action-store.js";
...
export type AgentConnectionSessionEntry = AgentConnectionSessionMessageEntry | AgentConnectionThinkingLevelChangeEntry | AgentConnectionServiceTierChangeEntry | AgentConnectionModelChangeEntry | AgentConnectionCompactionEntry | AgentConnectionBranchSummaryEntry | AgentConnectionCustomEntry | AgentConnectionChildUsageAttributionEntry | AgentConnectionCustomMessageEntry | AgentConnectionLabelEntry | AgentConnectionSessionInfoEntry | AgentConnectionSessionStateEntry | AgentConnectionAgentStatusEntry | AgentConnectionGitStateEntry;
...
export declare class AgentConnectionPromptAdmissionError extends Error {
...
export type AgentConnectionSessionEvent = AgentEvent | {
